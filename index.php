...
<?php include('inc/_menu.php'); ?>
	...
	<div class="fx-row">
		<div class="fx-col fx-col-3 fx-demo">.fx-col-3 - 3/12 = 25%<br> .fx-col - adds inner padding</div>
		<div class="fx-col fx-col-6 fx-demo">.fx-col-6 - 6/12 = 50%</div>
		<div class="fx-col fx-col-3 fx-demo">.fx-col-3 - 3/12 = 25%</div>
	</div>
	...
	<div class="fx-row">
		<div class="fx-col fx-col-sm-3 fx-col-xs-2 fx-col-xl-5 fx-demo">.fx-col-sm-3 .fx-col-xs-2 .fx-col-xl-5<br> column with 2 lines</div>
		<div class="fx-col fx-col-sm-6 fx-col-xs-2 fx-col-xl-5 fx-demo">.fx-col-sm-6 .fx-col-xs-2 .fx-col-xl-5</div>
		<div class="fx-col fx-col-sm-3 fx-col-xs-8 fx-col-xl-2 fx-demo">.fx-col-sm-3 .fx-col-xs-8 .fx-col-xl-2</div>
	</div>
	...
	<div class="fx-grid">
		<div class="fx-box fx-box-1 fx-demo">.fx-box-1 - 1/4 = 25%<br> .fx-box - adds inner padding</div>
		<div class="fx-box fx-box-2 fx-demo">.fx-box-2 - 2/4 = 50%;</div>
		<div class="fx-box fx-box-1 fx-demo">.fx-box-1 - 1/4 = 25%</div>
	</div>
